...
export default function CrudPage({ type }) {
  ...
  columns:["judul","created_at","published"]
},
 ...
 async function save(e) {
  ...
  // Jika kosong, simpan sebagai null,
  // bukan mengambil gambar lain.
  if (type === "berita") {
    payload.image = payload.image?.trim() || null;
    payload.judul = payload.judul?.trim() || "";
    payload.isi = payload.isi?.trim() || "";
  }
